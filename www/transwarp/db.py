...
class _DbCtx(threading.local):
	'''
	Thraed local object that holds connection info
	# 持有数据库连接的上下文对象
	'''
...
class _ConnectionCtx(object):
	'''
	_ConnectionCtx object that can open and close connection context. _ConnectionCtx object can be nested and only the most outer 
	connection has effect.
